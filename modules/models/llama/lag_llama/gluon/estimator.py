...
from gluonts.torch.modules.loss import DistributionLoss # added by filip
from gluonts.torch.modules.loss import NegativeLogLikelihood # added by Filip
#from gluonts.torch.distributions.distribution_output import DistributionLoss, NegativeLogLikelihood # modified by FILIP
...
class LagLlamaEstimator(PyTorchLightningEstimator):
    ...
    def __init__(
        ...
        device: torch.device = torch.device("cpu") # MODIFIED BY FILIP
    ) -> None:
